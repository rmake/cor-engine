...
def set_option(d)
  ...
  font_file = File.dirname(__FILE__) + "/pf_tempesta_five_condensed_bold.ttf"
...
def text_rect(text)
  ...
  return {:x => 0, :y => 0, :width => metrics.width.to_i + 14, :height => metrics.height.to_i + 14}
end
...
sz.times do |i|
  ...
  begin
    ...
    image.composite! img, x + [(mxw - img.columns) / 2, 0].max, y, Magick::OverCompositeOp
  rescue
