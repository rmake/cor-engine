...
namespace cor
{
    namespace mruby_interface
    {
        ...
        unsigned long BasicBind_cor__system__AllocationMonitor_get_new_count(cor::system::AllocationMonitor* c);
        unsigned long BasicBind_cor__system__AllocationMonitor_get_delete_count(cor::system::AllocationMonitor* c);
        unsigned long BasicBind_cor__system__AllocationMonitor_get_alloc_count(cor::system::AllocationMonitor* c);
        unsigned long BasicBind_cor__system__AllocationMonitor_get_alloc_size(cor::system::AllocationMonitor* c);
        ...
        void* BasicBind_cor__system__AllocationMonitor_alloc(unsigned long a0);
        void BasicBind_cor__system__AllocationMonitor_al_free(void * a0);
        void* BasicBind_cor__system__AllocationMonitor_al_realloc(void * a0, unsigned long a1);
        void BasicBind_cor__system__CorCrypt_set_enabled(int a0);
        int BasicBind_cor__system__CorCrypt_get_enabled();
        void BasicBind_cor__system__CorCrypt_encode(unsigned char * a0, unsigned long a1);
        void BasicBind_cor__system__CorCrypt_decode(unsigned char * a0, unsigned long a1);
        ...
        unsigned long BasicBind_cor__system__Logger_get_local_count(cor::system::Logger* c, int a0);
        unsigned long BasicBind_cor__system__Logger_get_local_debug_count(cor::system::Logger* c);
        unsigned long BasicBind_cor__system__Logger_get_local_info_count(cor::system::Logger* c);
        unsigned long BasicBind_cor__system__Logger_get_local_warn_count(cor::system::Logger* c);
        unsigned long BasicBind_cor__system__Logger_get_local_error_count(cor::system::Logger* c);
        unsigned long BasicBind_cor__system__Logger_get_local_fatal_count(cor::system::Logger* c);
        unsigned long BasicBind_cor__system__Logger_get_count(int a0);
        unsigned long BasicBind_cor__system__Logger_get_debug_count();
        unsigned long BasicBind_cor__system__Logger_get_info_count();
        unsigned long BasicBind_cor__system__Logger_get_warn_count();
        unsigned long BasicBind_cor__system__Logger_get_error_count();
        unsigned long BasicBind_cor__system__Logger_get_fatal_count();
        ...
        void BasicBind_cor__mruby_interface__AnyWP_use_count(cor::mruby_interface::AnyWP& c);
        ...
        void BasicBind_cor__RCharArray_get_allocator(std::weak_ptr<cor::RCharArray> c);
        ...
        MrubyRef BasicBind_cor__data_structure__CostGridSpacePath_accessor_get_path(cor::data_structure::CostGridSpacePath& c);
          ...
          void BasicBind_bind_func_5(mruby_interface::MrubyState& mrb)
          {
            ...
            binder.bind_custom_method("CorMrubyInterface", "AnyWP", "use_count", BasicBind_cor__mruby_interface__AnyWP_use_count);
