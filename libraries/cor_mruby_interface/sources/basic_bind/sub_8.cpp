...
namespace cor
{
    namespace mruby_interface
    {
        ...
        std::basic_string<char, std::char_traits<char> BasicBind_cor__mruby_interface__MrubyExperimentalTemplateStructRString_add(std::basic_string<char, std::char_traits<char> a0, std::basic_string<char, std::char_traits<char> a1);
        std::basic_string<char, std::char_traits<char> BasicBind_cor__mruby_interface__MrubyExperimentalTemplateStructRString_add2(std::weak_ptr<cor::mruby_interface::MrubyExperimentalTemplateStructRString> c, std::basic_string<char, std::char_traits<char> a0, std::basic_string<char, std::char_traits<char> a1, std::basic_string<char, std::char_traits<char> a2);
        void BasicBind_cor__mruby_interface__MrubyExperimentalTemplateStructRString_set_n(std::weak_ptr<cor::mruby_interface::MrubyExperimentalTemplateStructRString> c, std::basic_string<char, std::char_traits<char> a0);
